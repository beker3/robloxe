...
function Library:CreateWindow(title, color)
    ...
    core.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    core.BorderColor3 = Color3.fromRGB(12, 12, 12)
    core.Position = UDim2.new(0.156000003, 0, 0.140000001, 0)
    core.Size = UDim2.new(0, 540, 0, 531)
    core.BackgroundTransparency = 0.1
    core.BorderSizePixel = 0
    core.CornerRadius = UDim.new(0, 10) -- Rounded corners

    outlinecore.Name = "outlinecore"
    outlinecore.Parent = core
    outlinecore.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
    outlinecore.BorderSizePixel = 0
    outlinecore.Position = UDim2.new(0, 1, 0, 1)
    outlinecore.Size = UDim2.new(0, 538, 0, 529)
    outlinecore.BackgroundTransparency = 0.1
    outlinecore.BorderSizePixel = 0
    outlinecore.CornerRadius = UDim.new(0, 10) -- Rounded corners
    ...
    title_18.TextStrokeTransparency = 0.8
    ...
    inline.CornerRadius = UDim.new(0, 10) -- Rounded corners
    ...
    inlineoutline.CornerRadius = UDim.new(0, 10) -- Rounded corners
    ...
    inlinecore.CornerRadius = UDim.new(0, 10) -- Rounded corners
    ...
    tabbar.CornerRadius = UDim.new(0, 10) -- Rounded corners
    ...
    function WinTypes:CreateTab(name, players)
        ...
        title.Position = UDim2.new(0.100000001, 0, 0, 0)
        ...
        Pattern.ImageTransparency = 0.88
        Pattern.ScaleType = Enum.ScaleType.Tile
        Pattern.SliceCenter = Rect.new(0, 0, 256, 256)
        Pattern.TileSize = UDim2.new(0, 12, 0, 12)
        ...
        -- Tab Types
        function TabTypes:CreateSection(Name)
            Name = Name or "Section"

            -- Section Main
            local SectionTypes = {}
            local LeftSize, RightSize = 0, 0
            ...
            title.Size = UDim2.new(0.899999976, 0, 0, 16)
            title.Font = Enum.Font.GothamBold
            title.Text = Name
            title.TextColor3 = Color3.fromRGB(255, 255, 255)
            ...
            LeftSize = LeftSize + Section.Size.Y.Offset + UIListLayout_2.Padding.Offset
            Left.CanvasSize = UDim2.new(0, 0, 0, LeftSize)

            function SectionTypes:SetName(NewName)
                title.Text = NewName
            end
            ...
            function SectionTypes:CreateLabel(Name)
                Name = Name or "Label"
                ...
                label.Position = UDim2.new(0, 30, 0, 30)
                label.Size = UDim2.new(0, 442, 0, 30)
                label.ZIndex = 2
                ...
                LeftSize = LeftSize + label.Size.Y.Offset + UIListLayout_4.Padding.Offset
                Left.CanvasSize = UDim2.new(0, 0, 0, LeftSize)

                function LabelTypes:SetText(NewName)
                    title.Text = NewName
                end
            ...
            function SectionTypes:CreateButton(Name, Callback)
                ...
                button.BorderColor3 = Color3.fromRGB(12, 12, 12)
                button.Position = UDim2.new(0.0662221834, 0, 0.707317054, 0)
                button.Size = UDim2.new(0, 442, 0, 30)
                button.ZIndex = 2
                ...
                title.BackgroundTransparency = 1.000
                title.Position = UDim2.new(0.0500000007, 0, 0, 0)
                title.Size = UDim2.new(0, 421, 1, 0)
                title.Font = Enum.Font.Gotham
                title.Text = Name
                title.TextColor3 = Color3.fromRGB(255, 255, 255)
                title.TextSize = 14.000
                ...
                -- Update Canvas Size
                LeftSize = LeftSize + button.Size.Y.Offset + UIListLayout_4.Padding.Offset
                Left.CanvasSize = UDim2.new(0, 0, 0, LeftSize)

                function ButtonTypes:SetText(NewName)
                    title.Text = NewName
                end
                ...
                function ButtonTypes:SetIcon(IconID)
                    Icon.Image = "rbxassetid://"..IconID
                    Icon.ImageTransparency = 0
                end

                function ButtonTypes:GetIcon()
                    return Icon.Image
                end
            ...
            function SectionTypes:CreateToggle(Name, Default, Callback)
                Name = Name or "Toggle"
                ...
                Toggle.BorderColor3 = Color3.fromRGB(12, 12, 12)
                Toggle.Position = UDim2.new(0, 30, 0, 90)
                Toggle.Size = UDim2.new(0, 442, 0, 30)
                Toggle.ZIndex = 2
                ...
                Icon.ImageColor3 = Color3.fromRGB(255, 67, 67)
                ...
                -- Update Canvas Size
                LeftSize = LeftSize + Toggle.Size.Y.Offset + UIListLayout_4.Padding.Offset
                Left.CanvasSize = UDim2.new(0, 0, 0, LeftSize)

                function ToggleTypes:SetText(NewName)
                    title.Text = NewName
                end

                function ToggleTypes:GetText()
                    return title.Text
                end
            ...
            function SectionTypes:CreateSlider(Name, Min, Max, Default, Callback)
                Name = Name or "Slider"
                Min = Min or 0
                Max = Max
